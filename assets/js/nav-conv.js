    ...
    for (var mi = 0; mi < yg.months.length; mi++) {
      ...
      for (var ci = 0; ci < mg.convs.length; ci++) {
        ...
        navHTML +=
          ...
          (cur === c.href.split("/").pop() ? " sidebar-active" : "") +
          '" href="' +
          c.href +
          '">' +
          c.label +
